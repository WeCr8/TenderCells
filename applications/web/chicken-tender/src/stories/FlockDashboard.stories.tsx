...
const mockGroups: FlockGroup[] = [
  ...
  },
  {
    ...
    description: 'Birds under health observation',
    memberCount: 4,
    location: 'Isolation',
...
const meta: Meta<typeof FlockDashboard> = {
  title: 'Modules/Flock/FlockDashboard',
  component: FlockDashboard,
  parameters: {
    layout: 'fullscreen',
    docs: {
      description: {
        component: 'Main dashboard for flock management with stats overview, member cards, and group management.',
      },
    },
  },
  args: {
...
export default meta;
type Story = StoryObj<typeof FlockDashboard>;
...
export const HealthIssues: Story = {
  args: {
    stats: {
      ...mockStats,
      sickBirds: 5,
